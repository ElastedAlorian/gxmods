...
The mod is on the [GX Store](https://store.gx.me/mods/nckzux/iigx-iisu-theme-for-opera-gx-/) for easy access, but if you want to make your own changes or don't want to download the theme through there, you can download it through here.
...
## Preview
Splash Screens (at roughly 30% speed, export issue.)
![Display](images/Comparison.gif)
### Light Mode
